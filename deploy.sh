...
kubectl set image deployments/client-deployment client=thcrnk/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=thcrnk/multi-worker:$SHA